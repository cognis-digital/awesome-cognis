# Installing awesome-cognis

`awesome-cognis` runs anywhere Python 3.10+ runs. Pick your OS:
...
| **Any (pip)** | `pip install cognis-awesome-cognis` |
| **Docker** | `docker run --rm ghcr.io/cognis-digital/awesome-cognis:latest --help` |
